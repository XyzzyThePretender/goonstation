	...
	switch(job)
		...
		if("Head of Personnel")
			return list(access_security, access_carrypermit, access_contrabandpermit, access_brig, access_forensics_lockers, access_armory,
						...
						access_research, access_hydro, access_ranch, access_mail, access_ai_upload, access_microbiology)
		if("Head of Security")
#ifdef RP_MODE
			...
			return list(access_security, access_carrypermit, access_contrabandpermit, access_maxsec, access_brig, access_securitylockers, access_forensics_lockers, access_armory,
						...
						access_mining, access_microbiology)
#endif
		...
		if("Security Officer")
			...
			return list(access_security, access_brig, access_forensics_lockers, access_armory,
				...
				access_research, access_engineering_atmos, access_hangar, access_ranch, access_microbiology)
#else
			...
			access_chemistry, access_bar, access_kitchen, access_hydro, access_microbiology)
#endif
		if("Vice Officer")
		...
		if("Microbiologist")
			#ifdef SCIENCE_PATHO_MAP
			return list(access_tox, access_tox_storage, access_research, access_chemistry, access_microbiology)
			#else
			return list(access_medical, access_medical_lockers, access_morgue, access_microbiology, access_maint_tunnels)
			#endif
		if("Roboticist")
		...
		if("Inspector", "Communications Officer")
			return list(access_security, access_tox, access_tox_storage, access_chemistry, access_medical, access_medlab,
						...
						access_kitchen, access_robotics, access_cargo, access_research, access_hydro, access_ranch, access_microbiology)
...
/proc/get_all_accesses()  // not adding the special stuff to this
	return list(access_security, access_brig, access_forensics_lockers, access_armory,
	            ...
	            access_chapel_office, access_kitchen, access_medical_lockers, access_microbiology,
